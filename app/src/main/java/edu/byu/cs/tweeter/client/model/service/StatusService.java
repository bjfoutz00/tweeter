...
public class StatusService {
    ...
    public void loadMoreFeedStatuses(User user, int pageSize, Status lastStatus, Observer observer) {
    ...
    public void loadMoreStoryStatuses(User user, int pageSize, Status lastStatus, Observer observer) {
    ...
    public void onStatusPosted(Status newStatus, MainObserver observer) {
